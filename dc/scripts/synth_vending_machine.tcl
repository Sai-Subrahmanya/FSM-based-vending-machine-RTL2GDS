###############################################################################
# synth_vending_machine.tcl
# Design Compiler synthesis script for Vending Machine
...
set DESIGN_NAME vending_machine
...
require_file $SOURCE_DIR/vending_machine.sdc
...
source $SOURCE_DIR/vending_machine.sdc
...
write -hierarchy -format verilog -output $RESULT_DIR/vending_machine_compiled.v
write -hierarchy -format ddc     -output $RESULT_DIR/vending_machine_compiled.ddc
write_sdc $RESULT_DIR/vending_machine_out.sdc

###############################################################################
# Strip unwanted power budget commands from output SDC
###############################################################################

set clean_sdc $RESULT_DIR/vending_machine_out.sdc
...
file copy -force $RESULT_DIR/vending_machine_compiled.v ../../icc2/source/vending_machine_compiled.v
file copy -force $RESULT_DIR/vending_machine_out.sdc    ../../icc2/source/vending_machine_out.sdc
