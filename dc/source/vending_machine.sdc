...
set INPUT_DELAY_MAX_NS  1.000
set INPUT_DELAY_MIN_NS  0.000
set OUTPUT_DELAY_MAX_NS 1.000
set OUTPUT_DELAY_MIN_NS 0.000

set DATA_INPUTS [remove_from_collection [all_inputs] [get_ports {Clock rst}]]
...
# rst is synchronous in this RTL because it is inside always @(posedge Clock).
# Therefore it is treated as a normal synchronous input, not an async false path.
