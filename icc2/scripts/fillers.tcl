...
save_block -as vending_machine_final

write_verilog $RESULT_DIR/vending_machine_icc2.v

write_sdc -output $RESULT_DIR/vending_machine_icc2.sdc

write_parasitics \
    -output $RESULT_DIR/vending_machine_icc2.spef \
    -format spef

write_gds \
    -design vending_machine_final \
    -layer_map $GDS_MAP \
    -hierarchy all \
    -keep_data_type \
    ...
    $RESULT_DIR/vending_machine_final.gds
